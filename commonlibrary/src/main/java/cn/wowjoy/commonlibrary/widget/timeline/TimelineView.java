package cn.wowjoy.commonlibrary.widget.timeline;
...
public class TimelineView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        if(mMarker == null) {
            mMarker = mContext.getResources().getDrawable(R.drawable.workschdule_marker);
        }
    ...
    /**
     * Sets workschdule_marker.
     *
     * @param marker will set workschdule_marker drawable to timeline
     */
    ...
    /**
     * Sets workschdule_marker size.
     *
     * @param markerSize the workschdule_marker size
     */
    ...
    public void initLine(int viewType) {
        if(viewType == LineType.BEGIN) {
            setStartLine(null);
            if(mEndLine == null){
                mEndLine = new ColorDrawable(mContext.getResources().getColor(R.color.C_D1DBE9));
            }
        } else if(viewType == LineType.END) {
            setEndLine(null);
            if(mStartLine == null){
                mStartLine = new ColorDrawable(mContext.getResources().getColor(R.color.C_D1DBE9));
            }
        } else if(viewType == LineType.ONLYONE) {
            setStartLine(null);
            setEndLine(null);
        }else if(viewType == LineType.NORMAL){
            if(mStartLine == null){
                mStartLine = new ColorDrawable(mContext.getResources().getColor(R.color.C_D1DBE9));
            }
            if(mEndLine == null){
