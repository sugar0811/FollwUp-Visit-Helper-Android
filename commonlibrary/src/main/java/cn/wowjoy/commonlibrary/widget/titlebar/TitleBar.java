package cn.wowjoy.commonlibrary.widget.titlebar;
...
public class TitleBar extends ViewGroup implements View.OnClickListener {
    ...
    private void init(Context context) {
        ...
        DEFAULT_TEXT_COLOR = CommonUtils.getColor(R.color.C_FFFFFF);
        initView(context);
    }
    ...
    private void initView(Context context) {
        ...
        mLeftText.setCompoundDrawablePadding(DensityUtil.dip2px(6));
        mLeftText.setTextColor(DEFAULT_TEXT_COLOR);
        mLeftText.setTextSize(TypedValue.COMPLEX_UNIT_DIP, DEFAULT_ACTION_TEXT_SIZE);
        mLeftText.setSingleLine();
        mLeftText.setGravity(Gravity.CENTER_VERTICAL);
//        mLeftText.setClickable(true);
        mLeftText.setBackground(getResources().getDrawable(R.drawable.title_bar_icon_bg));
        ...
        mCenterText.setTextSize(TypedValue.COMPLEX_UNIT_DIP, DEFAULT_MAIN_TEXT_SIZE);
        mCenterText.setSingleLine();
        mCenterText.setTextColor(DEFAULT_TEXT_COLOR);
...
//        }
        ...
        if (0 != action.getDrawable()) {
            ImageView img = new ImageView(getContext());
            img.setId(R.id.action_image);
            img.setImageResource(action.getDrawable());
            actionImageView = img;
        }
        if (actionTextView != null && actionImageView != null) {
            LinearLayout linearLayout = new LinearLayout(getContext());
            linearLayout.setGravity(Gravity.CENTER_VERTICAL);
            linearLayout.setOrientation(LinearLayout.HORIZONTAL);
            linearLayout.addView(actionTextView);
            linearLayout.addView(actionImageView);
            view = linearLayout;
        } else if (actionTextView != null) {
            view = actionTextView;
        } else if (actionImageView != null) {
            view = actionImageView;
        }
        view.setPadding(mActionPadding, 0, mActionPadding + mOutPadding, 0);
        view.setBackground(getResources().getDrawable(R.drawable.title_bar_icon_bg));
        view.setTag(action);
