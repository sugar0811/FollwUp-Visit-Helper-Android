...
public class LayoutHelper {
     ...
     * @return 错误View
     */
    public static View getErrorView(LayoutInflater layoutInflater, ItemInfo item,
                                    final StateLayout layout) {
        View view = layoutInflater.inflate(R.layout.layout_error, null);
        return getView(item, layout, view);
    }

    private static View getView(ItemInfo item, final StateLayout layout, View view) {
        if (item != null) {
     ...
     * @return 超时View
     */
    public static View getTimeOutView(LayoutInflater layoutInflater, ItemInfo item,
                                      final StateLayout layout) {
     ...
     * @return 空数据View
     */
    public static View getEmptyView(LayoutInflater layoutInflater, ItemInfo item) {
