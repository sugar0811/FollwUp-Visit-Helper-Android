...
public class RecorderVoiceDialog extends Dialog implements View.OnTouchListener {
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        Log.e("xsasasasas", motionEvent.getY() + "");
        switch (motionEvent.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                btnSpeck.setBackgroundColor(ContextCompat.getColor(getContext(), R.color.white));
                break;
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (time < 1000) {
                    ...
                    if (onRecorderListener != null && !isFingerUp) {
                        Log.e("xsasasasas", recorderUtil.getFilePath() + "-------------------------" + recorderUtil.getTimeInterval());
