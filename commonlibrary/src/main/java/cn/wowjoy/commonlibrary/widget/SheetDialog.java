...
public class SheetDialog extends Dialog {
    ...
    public static class Builder {
        ...
        public Builder addSheets(ArrayList<String> arrayList,OnClickListener listener){
            for (String s : arrayList) {
                Sheet sheet = new Sheet(s, listener);
                this.p.menuList.add(sheet);
            }
            return this;
        ...
        public SheetDialog create() {
            ...
            if (hasTitle) {
                ...
                tTitle.setTextColor(CommonUtils.getColor(R.color.C_666666));
            ...
            for (int i = 0; i < p.menuList.size(); i++) {
                ...
                bbm.setTextColor(CommonUtils.getColor(R.color.C_666666));
                bbm.setTextSize(18);
                final int finalI = i;
