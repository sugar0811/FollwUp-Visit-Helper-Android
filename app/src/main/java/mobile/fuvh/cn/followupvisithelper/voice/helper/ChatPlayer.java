...
public class ChatPlayer {
    private static final String TAG = cn.wowjoy.commonlibrary.utils.ChatPlayer.class.getSimpleName();
    ...
    public static ChatPlayer getInstance() {
        if (mChatPlayer == null) {
            synchronized (cn.wowjoy.commonlibrary.utils.ChatPlayer.class) {
                if (mChatPlayer == null) {
