...
public class PlaybackFragment extends DialogFragment {
    ...
    public PlaybackFragment newInstance(RecordBean item) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("itemDuration",itemDuration+"....");
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        ColorFilter filter = new LightingColorFilter
                (getResources().getColor(R.color.C_494949), getResources().getColor(R.color.C_494949));
        ...
        mFileNameTextView.setText(item.getRecordName());
    ...
    private void startPlaying() {
        ...
        try {
            ...
            mMediaPlayer.setDataSource(item.getRecordPath());
